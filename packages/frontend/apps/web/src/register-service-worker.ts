// Web-only: @affine/core (where the rest of this app's bootstrap logic
// lives) is shared across the mobile/electron/ios/android app-shell
// targets too, none of which should get a service worker — see
// _bmad-output/specs/spec-pwa-conversion/SPEC.md's Constraints. That's why
// this file lives in packages/frontend/apps/web rather than @affine/core.
